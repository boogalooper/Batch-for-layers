...
checkboxBackground.onClick = function (){atnXML.settings.doBackground= this.value; tpanel.label=1}
...
{   if (this.selection !=0) {checkboxBackground.enabled = false} else {checkboxBackground.enabled = true}
    atnXML.settings.kind=this.selection.index; tpanel.label = 1
    }
...
function createProgressWindow(title, message, min, max,paletteMode) {
