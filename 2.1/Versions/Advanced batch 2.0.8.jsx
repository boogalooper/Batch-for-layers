...
cptOk = ["Обработка", "Processing"];cptOk =cptOk[atnXML.settings.langId]
...
cptLang =[ "Интерфейс", "Interface"];cptLang =cptLang[atnXML.settings.langId]
...
cptType =["Обработка слоев следующих типов:","Process following types of layers:"];cptType=cptType[atnXML.settings.langId]
...
cptProgress= ["прогресс-бар во время обработки","show progress bar during processing"], cptProgress= cptProgress[atnXML.settings.langId]
